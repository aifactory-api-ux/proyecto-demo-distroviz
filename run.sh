...
# Wait for nginx proxy to be healthy
print_status "Waiting for nginx proxy to be healthy..."
nginx_attempts=0
...
if [ $nginx_attempts -eq $max_nginx_attempts ]; then
    print_warning "Nginx proxy may not be fully ready yet, but continuing..."
fi
